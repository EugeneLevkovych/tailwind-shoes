        ...
        <div className="flex flex-col space-y-4 lg:flex-row-reverse dark:text-white">
            <div className="flex-1 lg:-mt-32 lg:ml-28">
                <div className="flex-center h-full bg-gradient-to-br from-[#F637CF] from-5% via-40% via-[#E3D876] to-[#4DD4C6]">
                  <img className="animate-float" src={shoe.src} alt="Nike" />
                </div>
            </div>
          <div className="flex-1 space-y-6">
            ...
            <button onClick={() => onClickAdd(shoe, form.qty, form.size)} className="btn-press-anim h-14 w-44 bg-black dark:bg-white dark:text-black text-white hover:bg-gray-900 active:bg-gray-700">
                Add to bag
            </button>
