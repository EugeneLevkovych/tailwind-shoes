export default function Sidebar({children, isOpen, onClickClose}) {
  ...
  return (
<div>
    <div className={`fixed right-0 top-0 z-50 h-full w-full md:w-[50%] lg:w-[35%] transform bg-white transition duration-300 p-5 overflow-y-auto dark:bg-night ${isOpen ? "translate-x-0" : "translate-x-full" }`}>
      <button 
